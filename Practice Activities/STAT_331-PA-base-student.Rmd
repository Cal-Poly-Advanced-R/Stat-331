...
This chunk will load up the encoded secret message as a vector.  (You may need to alter your path to wherever you saved the file "PA_Secret_Code")

```{r}

top_secret <- read.csv("../Data/PA_Secret_Code", header = FALSE)$V1
