...
First, save this file somewhere in your project folder.  Then create an **R Script** (not R Markdown!) file called "PA_Scripts.R" to the main part of your project folder.  

Then follow the steps below, all in the file "PA_Scripts.R"

1. Write a function called `divide_and_round()`, which takes a number or vector of numbers, divides them all by their smallest value, and rounds the results to the nearest whole number. This has been started for you in "PA_Scripts.R"
